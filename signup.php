...
<ul style=" background-color: #1d0f00;">
        <li ><a><i class="fas fa-hand-holding-usd"></i><h2> TRUST BANK</h2>&nbsp;&nbsp;&nbsp;&nbsp;</a></li> 
    </ul>
        ...
        <div class="formbody">        
            <div class="signupleft" style="height: 415px;">
                <form action="" class="formleft" method="">
                    <input type="text" id="accno" name="accno" class="forminputtext" minlength="3" placeholder="   Create your  account no." required>
                    <br>
